...
public class EmployeeServlet extends HttpServlet {
    ...
    private final String TITLE = 
        "Chapter 14: Using separate files for mappings, persistence unit metadata, queries and entities.";
    
    private final String DESCRIPTION = 
        "This example demonstrates how to split the metadata, mapping info, and entities into separate files.";
