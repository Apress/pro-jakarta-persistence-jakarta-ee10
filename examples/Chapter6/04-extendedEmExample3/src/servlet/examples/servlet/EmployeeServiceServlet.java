...
public class EmployeeServiceServlet extends HttpServlet {
    ...
    private final String TITLE = 
        "Chapter 6: Stateful Session bean and EntityManager Example (Third and Correct Attempt)";
    
    private final String DESCRIPTION = 
        "This example demonstrates how the department Entity doesn't have to be found for each "+
        "operation and the the results are updated in the database.";
