...
public class EmployeeServiceServlet extends HttpServlet {
    ...
    private final String TITLE = 
        "Chapter 6: Stateful Session bean and EntityManager Example (First Attempt)";
    
    private final String DESCRIPTION = 
        "This example demonstrates how the department entity must be found " +
        "before performing each operation";
