...
public class EmployeeServiceServlet extends HttpServlet {
    ...
    private final String TITLE = 
        "Chapter 6: Stateful Session bean and EntityManager Example (Second Attempt)";
    
    private final String DESCRIPTION = 
        "This example demonstrates how detached entities do not have any " +
        "changes persisted to the database.  Look at the console and you will not see any UPDATE statements.";
    ...
    private void printManagementActions(PrintWriter out, DepartmentManager deptManager) {
        ...
        out.println("</tbody></table>");
        out.println("<hr/>");
        out.println("<h3>Set Department Name</h3>");
        out.println("<table><tbody>");
