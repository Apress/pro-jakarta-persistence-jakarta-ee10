...
public class EmployeeServiceServlet extends HttpServlet {
    ...
    private final String TITLE = 
        "Chapter 10: Unidirectional One-to-many Relationship Example";
    
    private final String DESCRIPTION = 
        "This example demonstrates a unidirectional one-to-many relationship mapping that does not use a join table.";
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        } else if (action.equals("AddEmployeeToDept")) {
            Department dept = deptService.addEmployeeToDepartment(
                    parseInt(request.getParameter("deptId")),
                    parseInt(request.getParameter("empId")));
            out.println("Updated " + dept + "</br>");
    ...
    private void printHtmlHeader(PrintWriter out) throws IOException {
        ...
        out.println("<hr/>");
        out.println("<h3>Add an Employee to a Department</h3>");
        out.println("<table><tbody>");
        ...
        out.println("<tr><td><input name=\"action\" type=\"submit\" value=\"AddEmployeeToDept\"/></td></tr>");
        out.println("</tbody></table>");
        out.println("<hr/>");
        // form to find all
