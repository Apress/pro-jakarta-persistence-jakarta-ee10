...
public class EmployeeServiceServlet extends HttpServlet {
    ...
    private final String TITLE = 
        "Chapter 10: Using Table per Class Inheritance Example";
    
    private final String DESCRIPTION = 
        "This example demonstrates the basics of using separate table for each entity in the inheritance hierarchy.";
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (action == null) {
            ...
            } else if (request.getParameter("type").equals("Part")) {
                emp = new PartTimeEmployee();
            } else {
                emp = new ContractEmployee();
            }
            emp.setId(parseInt(request.getParameter("empId")));
