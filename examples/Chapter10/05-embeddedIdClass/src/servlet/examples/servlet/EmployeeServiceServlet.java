...
public class EmployeeServiceServlet extends HttpServlet {
    ...
    private final String TITLE = 
        "Chapter 10: Using Embedded Id Class Example";
    
    private final String DESCRIPTION = 
        "This example demonstrates the basics of using an embedded id class.";
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (action == null) {
            ...
            Employee emp = service.findEmployee(
                    request.getParameter("findCountry"),
                    parseInt(request.getParameter("findId")));
            out.print("Found " + emp + "<hr>");
        }
    ...
    private void printHtmlHeader(PrintWriter out) throws IOException {
        ...
        out.println("<table><tbody>");
        out.println("<tr><td>Employee Country:</td><td><input type=\"text\" name=\"findCountry\"/>(String)</td></tr>");
        out.println("<tr><td>Employee Id:</td><td><input type=\"text\" name=\"findId\"/>(int)</td>" +
