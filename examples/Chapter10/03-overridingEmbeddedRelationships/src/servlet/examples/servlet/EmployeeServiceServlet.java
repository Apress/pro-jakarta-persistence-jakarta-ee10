...
@WebServlet(name="EmployeeServlet", 
 ...
 public class EmployeeServiceServlet extends HttpServlet {
    ...
    private final String TITLE = 
        "Chapter 10: Overriding Embedded Relationships Example";
    
    private final String DESCRIPTION = 
        "This example demonstrates how to override relationships mapped in embeddable objects.";
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (action == null) {
            ...
            Employee emp = service.createEmployeeAndAddress(
            ...
            Customer cust = service.createCustomerAndAddress(
        ...
        out.println("<br/>Customers and Addresses: </br>");
    ...
    private void printHtmlHeader(PrintWriter out) throws IOException {
        ...
        out.println("<tr><td>Address Zip:</td><td><input type=\"text\" name=\"zip\"/>(String)</td>" +
                    "<td><input name=\"action\" type=\"submit\" value=\"CreateEmp\"/></td></tr>");
        out.println("</tbody></table>");
        out.println("<hr/>");
        
        out.println("<h3>Create a Customer and Address</h3>");
        out.println("<table><tbody>");
        out.println("<tr><td>Company Name:</td><td><input type=\"text\" name=\"cId\"/>(String)</td></tr>");
        ...
        out.println("<tr><td>Address Zip:</td><td><input type=\"text\" name=\"cZip\"/>(String)</td>" +
                    "<td><input name=\"action\" type=\"submit\" value=\"CreateCustomer\"/></td></tr>");
        out.println("</tbody></table>");
        out.println("<hr/>");
    }
