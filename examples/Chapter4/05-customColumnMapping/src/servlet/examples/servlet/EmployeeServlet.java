...
public class EmployeeServlet extends HttpServlet {
    ...
    private final String TITLE = 
        "Chapter 4: Custom Column Mapping Example";
    
    private final String DESCRIPTION = 
        "This example demonstrates how to specify custom column names for entities attributes.</br> " +
    ...
    private void printHtmlHeader(PrintWriter out) throws IOException {
        ...
        out.println("<tr><td>Employee Comments:</td><td><input type=\"text\" name=\"comments\"/>(String)</td></tr>");
