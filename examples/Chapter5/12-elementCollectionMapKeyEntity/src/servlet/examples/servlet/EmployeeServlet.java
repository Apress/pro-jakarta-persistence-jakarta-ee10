...
public class EmployeeServlet extends HttpServlet {
    ...
    private final String TITLE = 
        "Chapter 5: Element Collection Map Example Keyed by Entity";
    
    private final String DESCRIPTION = 
        "This example demonstrates how to work with element collection Maps.</br> " +
        "The Map contains entity keys and integer values.";
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        } else if (action.equals("SetEmployeeSeniority")) {
            Employee emp = deptService.setEmployeeSeniority(
                    parseInt(request.getParameter("deptId")),
                    parseInt(request.getParameter("empId")),
                    parseInt(request.getParameter("seniority")));
            out.println("Updated seniority of " + emp + "</br>");
    ...
    private void printHtmlHeader(PrintWriter out) throws IOException {
        ...
        out.println("<tr><td>Seniority:</td><td><input type=\"text\" name=\"seniority\"/>(int)</td></tr>");
        out.println("<td><input name=\"action\" type=\"submit\" value=\"SetEmployeeSeniority\"/></td></tr>");
        out.println("</tbody></table>");
        out.println("<hr/>");
        // form to find all
