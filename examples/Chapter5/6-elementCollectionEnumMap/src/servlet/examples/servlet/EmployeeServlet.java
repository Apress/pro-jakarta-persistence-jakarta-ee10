...
public class EmployeeServlet extends HttpServlet {
    ...
    private final String TITLE = 
        "Chapter 5: ElementCollection Map Keyed by Enumerated Type Example";
    
    private final String DESCRIPTION = 
        "This example demonstrates how to work with ElementCollections that are Maps.</br> " +
        "The Map contains keys that are of an enumerated type and String values.";
