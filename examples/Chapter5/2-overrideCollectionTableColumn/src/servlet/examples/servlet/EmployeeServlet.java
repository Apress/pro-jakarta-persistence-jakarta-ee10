...
public class EmployeeServlet extends HttpServlet {
    ...
    private final String TITLE = 
        "Chapter 5: Overriding ElementCollection Tables and Columns Example";
    
    private final String DESCRIPTION = 
        "This example demonstrates how to override the mapping information for an ElementCollection.</br> ";
