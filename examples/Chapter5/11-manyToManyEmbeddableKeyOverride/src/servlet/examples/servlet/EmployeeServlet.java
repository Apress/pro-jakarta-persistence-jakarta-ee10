...
public class EmployeeServlet extends HttpServlet {
    ...
    private final String TITLE = 
        "Chapter 5: Many-To-Many Map Example With Embeddable Key Override";
    
    private final String DESCRIPTION = 
        "This example demonstrates how to work with relationship Maps.</br> " +
        "The Map contains embeddable keys and entity values.";
    ...
    private void printHtmlHeader(PrintWriter out) throws IOException {
        ...
        out.println("<tr><td>Employee First Name:</td><td><input type=\"text\" name=\"empFName\"/>(String)</td></tr>");
        out.println("<tr><td>Employee Last Name:</td><td><input type=\"text\" name=\"empLName\"/>(String)</td></tr>");
