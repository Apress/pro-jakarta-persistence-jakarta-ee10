...
public class EmployeeServiceServlet extends HttpServlet {
    ...
    private final String TITLE = 
        "Chapter 11: Dynamic Entity Graph with Root Inheritance";
    
    private final String DESCRIPTION = 
        "This example demonstrates the basics of a dynamic entity graph using inheritance from the root entity.";
