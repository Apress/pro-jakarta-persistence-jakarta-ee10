...
public class EmployeeServiceServlet extends HttpServlet {
    ...
    private final String TITLE = 
        "Chapter 11: Accessing Named Entity Graphs";
    
    private final String DESCRIPTION = 
        "This example demonstrates how to discover and access existing named entity graphs.";
    ...
    private void printHtmlHeader(PrintWriter out) throws IOException {
        ...
        out.println("<h3>Find all named entity graphs for ContractEmployee</h3>");
