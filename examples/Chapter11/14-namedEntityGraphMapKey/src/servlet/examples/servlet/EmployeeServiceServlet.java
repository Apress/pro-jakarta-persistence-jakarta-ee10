...
public class EmployeeServiceServlet extends HttpServlet {
    ...
    private final String TITLE = 
        "Chapter 11: Named Entity Graph with With Map Key Subgraph";
    
    private final String DESCRIPTION = 
        "This example demonstrates the basics of a named entity graph with a Map key subgraph.";
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (action == null) {
            ...
            out.println("Prevented from executing due to bug in EclipseLink. <br/>See:  https://bugs.eclipse.org/bugs/show_bug.cgi?id=417046");
        /*	
