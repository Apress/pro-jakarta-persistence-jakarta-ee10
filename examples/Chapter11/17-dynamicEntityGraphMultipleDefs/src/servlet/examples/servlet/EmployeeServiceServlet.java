...
public class EmployeeServiceServlet extends HttpServlet {
    ...
    private final String TITLE = 
        "Chapter 11: Dynamic Entity Graph with Multiple Definitions for the Same Type";
    
    private final String DESCRIPTION = 
        "This example demonstrates the basics of a dynamic entity graph having multiple definitions for the same entity type.";
