...
public class EmployeeServiceServlet extends HttpServlet {
    ...
    private final String TITLE = 
        "Chapter 12: Using Predefined Contraints during Validation Example";
    
    private final String DESCRIPTION = 
        "This example demonstrates the basics of using predefined constraints during entity validation." +
        " See server console for constraint violation exceptions.";
