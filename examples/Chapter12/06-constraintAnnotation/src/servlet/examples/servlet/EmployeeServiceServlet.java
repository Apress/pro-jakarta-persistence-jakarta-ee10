...
public class EmployeeServiceServlet extends HttpServlet {
    ...
    private final String TITLE = 
        "Chapter 12: Validation Constraint Annotation Example";
    
    private final String DESCRIPTION = 
        "This example demonstrates the basics of Creating a Custom Validation Constraint.";
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (action == null) {
            ...
            service.createEmployee(
                    ...
                    parseInt(request.getParameter("hours")),
                    out);
    ...
    private void printHtmlHeader(PrintWriter out) throws IOException {
        ...
        out.println("<tr><td>Vacation Hours:</td><td><input type=\"text\" name=\"hours\"/>(int) (Multiples of 2 hours)</td></tr>");
        out.println("</td></tr>");
