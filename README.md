...
| 08 Dependency Lookup                   |     N      |      Y      |            |  NA   |       NA        | This Code is not an InitialContext example but instead is EJB Context, and differs from books description. The code is almost the same as the 09 example. <br/> TomEE failed to find EJB Resource in Department Service.                                  |
| 09 EJB Lookup                          |     N      |      Y      |     Y      |   NA  |       NA        | Code is the same as Example 08 , except for some HTMl text. Seems to be redundant.                                                                                                                                                                        |                                                                                                                                                         |
